...
from hub.models import Journal, Category, Author
...
authors = ['John', 'Ezra', 'Patrick', 'Ignatius', 'Kevo', 'Bill', 'Brian', 'Clinton']
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            'file_name', type=str, help='to get help info, checkout this file')
